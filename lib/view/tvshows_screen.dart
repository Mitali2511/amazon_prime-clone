...
List<HelperModel> slides = [
    ...
    HelperModel(
        image_slides: 'assets/images/goblin.jpg',
  ...
  final controller_tv = PageController(viewportFraction: 0.8, keepPage: false);
...
if (controller_tv.hasClients){
        controller_tv.animateToPage(currentPageIndex,
